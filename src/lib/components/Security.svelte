	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
		<div class="bg-[#F3F3F1] p-12 rounded-lg border border-gray-200 flex flex-col items-center text-center hover:bg-[#EAEAE8] transition-colors">
			...
			<div class="flex items-center gap-2 mb-4 text-primary-600">
				...
				<span class="font-mono text-xs uppercase tracking-widest">ENTERPRISE-READY</span>
			</div>
			<p class="text-gray-600 text-sm max-w-sm">
				Custom integrations, templates, and premium support for enterprise teams. <a href="/" class="underline decoration-gray-400 hover:text-gray-900">Learn more</a>
			</p>
		</div>
		...
		<div class="bg-[#F3F3F1] p-12 rounded-lg border border-gray-200 flex flex-col items-center text-center hover:bg-[#EAEAE8] transition-colors">
			...
			<div class="flex items-center gap-2 mb-4 text-primary-600">
				...
				<span class="font-mono text-xs uppercase tracking-widest">SECURE BY DEFAULT</span>
			</div>
			<p class="text-gray-600 text-sm max-w-sm">
				All data is encrypted at rest and in transit. We follow industry-standard security practices to protect your codebase.
			</p>
		</div>
	</div>
</section>
